    ...
    return ( 
        <div className="h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] flex flex-col text-red-500 lg:flex-row">
            ...
            <div className="h-1/2 p-4 flex flex-col justify-center overflow-scroll lg:h-full lg:w-2/3 2xl:w-1/2 lg:px-20 xl:px-40">
                ...
                <div className="flex items-center justify-between mb-4">
                    <Image src="/temporary/p9.png" alt="" width={100} height={100}/>
                    <div className="">
                        <h1 className="text-xl uppercase font-bold">ny-style</h1>
                        <span>Large</span>
                    </div>
                    <h2 className="font-bold">$27.60</h2>
                    <span className="cursor-pointer">X</span>
                </div>
                <div className="flex items-center justify-between mb-4">
                    <Image src="/temporary/p4.png" alt="" width={100} height={100}/>
                    <div className="">
                        <h1 className="text-xl uppercase font-bold">milanese</h1>
                        <span>Large</span>
                    </div>
                    <h2 className="font-bold">$31.90</h2>
                    <span className="cursor-pointer">X</span>
                </div>
            </div>
            {/* PAYMENT CONTAINER */}
